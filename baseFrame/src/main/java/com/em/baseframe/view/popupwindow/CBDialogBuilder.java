...
//    public static final int DIALOG_STYLE_CUSTOM = -1;
    ...
    */
     ...
     * @return
     */
    public CBDialogBuilder setBg(Drawable drawable){
        LinearLayout linearLayout = getView(R.id.cb_dialog_root_layout);
     ...
     * 点击返回按钮不让他dismiss
     *
     * 以下代码加在activity或者fragment里 然后调用此方法传进来
     ...
     * @return
     */
    public CBDialogBuilder setOnKeyListener(DialogInterface.OnKeyListener onKeyListener){
