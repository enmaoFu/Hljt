 ...
 * @author enmaoFu
 */
public abstract class BaseActivity1 extends AppCompatActivity implements HttpCallBack{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mStateManger = new ViewStateManger(this, content, contentView, R.layout.frame_error_layout, R.layout.frame_loading_content_dialog, new ViewStateManger.BtnRefreshClickListener() {
            ...
            public void onRefreshClick() {
                //判断网络是否可用
                if (NetWorkUtils.isNetworkConnected(BaseActivity1.this)) {
                    requestData();
                } else {
    ...
    protected void initStatusBar() {
        ...
        StatusBarUtil.setColorNoTranslucent(this, getResources().getColor(R.color.app_main_bg));
    }
    ...
    public void doHttp(Call<ResponseBody> bodyCall, final int what) {
        bodyCall.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(Call<ResponseBody> call, Response<ResponseBody> response) {
                ...
                try {
                    ...
                    if (object.containsKey("code")) {
                        ...
                        if (code == 200) {
                            BaseActivity1.this.onSuccess(result, call, response, what);
                        } else {
                            BaseActivity1.this.onFailure(result, call, response, what);
                        }
                    }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                ...
                BaseActivity1.this.onError(call, t, what);
